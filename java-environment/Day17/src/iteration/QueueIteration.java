...
public class QueueIteration {
	public static void main(String[] args) {
		...
		/*
		 * Note: As stated previously, many data structures
		 * (including priorityQueues) do not guarantee the 
		 * order of traversal, as a result of how the data
		 * is managed. Even if the data structure itself
		 * uses some sort of 'ordering' (Abstraction!). This is

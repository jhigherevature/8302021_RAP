...
/*
REVOKE ALL PRIVILEGES ON ALL TABLES IN SCHEMA lecture FROM customers;

REVOKE ALL PRIVILEGES ON ALL TABLES IN SCHEMA examples FROM customers;
REVOKE ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA examples FROM customers;
REVOKE ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA examples FROM customers;
REVOKE ALL PRIVILEGES ON SCHEMA examples FROM customers;

REVOKE ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public FROM customers;
REVOKE ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public FROM customers;

REVOKE ALL PRIVILEGES ON DATABASE postgres FROM customers;

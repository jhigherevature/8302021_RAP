...
Given the following tables, provide an SQL Statement that would add a new book written by George Orwell. You can assume that the Books table uses the Serial Datatype for the Book_id column.
